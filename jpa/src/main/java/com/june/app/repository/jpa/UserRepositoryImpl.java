...
public class UserRepositoryImpl implements UserRepository {
	...
	public UserInfo getUser(String userId) {
		Query query = this.em
				.createQuery("SELECT userInfo FROM UserInfo userInfo WHERE userInfo.userId =:userId");
	...
	public UserInfo getUserByLogin(String userId) {
		Query query = this.em
				.createQuery("SELECT userInfo FROM UserInfo userInfo left join fetch userInfo.userRoleInfos WHERE userInfo.userId =:userId");
		query.setParameter("userId", userId);
